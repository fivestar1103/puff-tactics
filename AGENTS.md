...
- "Keep `src/scripts/feed/feed_main.gd` `SNAPSHOT_Y_RATIO` near `0.38-0.42`; drifting below 0.30 pushes content too high, drifting above 0.46 creates oversized subtitle-to-status empty zone on portrait layouts."
